  ...
  public static void main(String[] args) throws IOException {
	  String outputFile,inputFile;
		...
		for(CreditCardEntry eachCreditCardEntry : creditCardEntries) {
			...
			String creditCardType = ccHandler.check(eachCreditCardEntry);
		    System.out.println(" credit card type is " + creditCardType);
			System.out.println(" each credit card entry get number is " + eachCreditCardEntry.getCardNumber());
			long ccNumber = eachCreditCardEntry.getCardNumber();
